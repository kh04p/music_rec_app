...
function loadscreen_off() {
    ...
    document.getElementById("blur").className = "z-20";
}
...
async function spotify_get_token() {
    ...
    if (response.ok) {
        ...
        alert("Spotify API token request failed. Please try again.");
    }
}
...
async function spotify_get_playlists(weather) {
    ...
    if (response.ok) {
        ...
        alert("Spotify API playlist request failed. Please try again.");
        loadscreen_off();
    }
}
...
async function ps_get_location(lat,lon) {
    ...
    if (response.ok) {
        ...
        alert("Location API call failed. Please try again.");
        loadscreen_off();
    }
...
async function owm_get_weather(lat,lon) {
    ...
    if (response.ok) {
        ...
        alert("OpenWeatherMap API call failed. Please try again.");
        loadscreen_off();
    }
}
...
async function set_playlists(weather) {
    ...
    console.log(spotify_playlist_api_response);
...
function check_playlist_overflow() {
    p1_name = document.getElementById("playlist1_name");
    p2_name = document.getElementById("playlist2_name");
    p3_name = document.getElementById("playlist3_name");

    const p1_overflow = isOverflown(p1_name);
    const p2_overflow = isOverflown(p2_name);
    const p3_overflow = isOverflown(p3_name);

    console.log(p1_overflow);
    console.log(p2_overflow);
    console.log(p3_overflow);

    switch(p1_overflow) {
        case false:
            p1_name.className = "font-semibold text-slate-600 text-md flex justify-center items-center";
            break;
        case true:
            p1_name.className = "font-semibold text-slate-600 text-md truncate";
            break;
        default: break;
    }
    ...
    switch(p2_overflow) {
        case false:
            p2_name.className = "font-semibold text-slate-600 text-md flex justify-center items-center";
            break;
        case true:
            p2_name.className = "font-semibold text-slate-600 text-md truncate";
            break;
        default: break;
    }
    ...
    switch(p3_overflow) {
        case false:
            p3_name.className = "font-semibold text-slate-600 text-md flex justify-center items-center";
            break;
        case true:
            p3_name.className = "font-semibold text-slate-600 text-md truncate";
            break;
        default: break;
    }
}